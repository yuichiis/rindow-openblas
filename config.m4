...
if test "$PHP_RINDOW_OPENBLAS" != "no"; then
  ...
  AC_MSG_RESULT(OPENMP_LINK_FLAG: $OPENMP_LINK_FLAG)
  AC_MSG_RESULT(RINDOW_OPENBLAS_SHARED_LIBADD: $RINDOW_OPENBLAS_SHARED_LIBADD)
  PHP_SUBST(RINDOW_OPENBLAS_SHARED_LIBADD)
  dnl # PHP_SUBST(OPENMP_LINK_FLAG)
